...
public class PillowactivityActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_settings) {
            ...
            Intent intent = new Intent(PillowactivityActivity.this,MainActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_pillow) {
            Intent intent = new Intent(PillowactivityActivity.this,PillowactivityActivity.class);
            startActivity(intent);
        }
